                            ...
                            <tbody>
                                <?php foreach ($posts as $post) { ?>
                                    <tr>
                                        ...
                                        <td><a href="./show.php?id=<?php echo $post['id'] ?>" class="btn btn-success">Показать</a></td>
                                        <td><a href="./edit.php?id=<?php echo $post['id'] ?>" class="btn btn-primary">Редактировать</a></td>
                                        <td><a href="./destroy.php?id=<?php echo $post['id'] ?>" class="btn btn-danger">Удалить</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
