            ...
            <div class="col-12">
                <form action="./update.php?id=<?php echo $post['id'] ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="text" name="title" placeholder="Заголовок" class="form-control" value="<?php echo $post['title'] ?>" required>
                    </div>
                    <?php 
                    ...
                    <?php } ?>
                    <img src="./../../img/<?php echo $post['image'] ?>" style="width: 250px" class="mb-3">
                    <div class="mb-3">
                  ...
                  <input type="file" name="image" id="input-file" class="d-none">
                    ...
                    <?php } ?>
                    <div class="form-group">
                        <textarea type="text" name="content" placeholder="Контент" class="form-control" required><?php echo $post['content'] ?></textarea>
                    </div>
                    <?php 
